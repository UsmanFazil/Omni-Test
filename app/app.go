...
import (
	...
	omnimodule "Omni/x/omni"
	omnimodulekeeper "Omni/x/omni/keeper"
	omnimoduletypes "Omni/x/omni/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport

	appparams "Omni/app/params"
	"Omni/docs"
)
...
func New(
	...
	*/
	...
	app.OmniKeeper = *omnimodulekeeper.NewKeeper(
		appCodec,
		keys[omnimoduletypes.StoreKey],
		keys[omnimoduletypes.MemStoreKey],
		app.GetSubspace(omnimoduletypes.ModuleName),
	)
